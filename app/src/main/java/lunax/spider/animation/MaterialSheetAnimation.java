package lunax.spider.animation;
...
import lunax.spider.widget.MaterialSheetFab.RevealXDirection;
import lunax.spider.widget.MaterialSheetFab.RevealYDirection;
...
public class MaterialSheetAnimation {
	...
	protected void startCircularRevealAnim(View view, int centerX, int centerY, float startRadius,
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
			...
			// Setup animation
			SupportAnimator anim = lunax.spider.animation.ViewAnimationUtils
