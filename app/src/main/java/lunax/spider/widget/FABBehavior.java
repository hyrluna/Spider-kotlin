 ...
 */
public final class FABBehavior<V extends View> extends VerticalScrollingBehavior<V> {
...
//    private View mTabsHolder;
    ...
    public static <V extends View> FABBehavior<V> from(@NonNull V view) {
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, V child, int layoutDirection) {
        ...
        if (mFAB == null && mTabLayoutId != View.NO_ID) {
            mFAB = findTabLayout(child);
//            getTabsHolder();
        }
    ...
    private void handleDirection(V child, @ScrollDirection int scrollDirection) {
        ...
        if (scrollDirection == ScrollDirection.SCROLL_DIRECTION_DOWN && hidden) {
            ...
            hidden = true;
            animateOffset(child, child.getHeight() + 300);
        }
    }
...
//        if (mTabsHolder != null) {
//            offset = offset > 0 ? 0 : 1;
//            ViewCompat.animate(mTabsHolder).alpha(offset).setDuration(500).start();
//        }
//    }
    ...
    private void ensureOrCancelAnimator(V child) {
        if (mOffsetValueAnimator == null) {
            ...
            mOffsetValueAnimator.setDuration(500);
